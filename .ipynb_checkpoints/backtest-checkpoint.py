...
class QlibBacktest:
    ...
    def run(
        ...
        # try: 
        #     report_graph(report, show_notebook=True)[0]
        # except Exception:
        #     pass
...
if __name__ == "__main__":
    ...
    POOL_PATH = '/root/alphagen/10240_steps_pool.json'
    DT_PATH = '/root/alphagen/10240_steps_dt.txt'
    ...
    ensemble_alpha = calculator.make_ensemble_alpha(exprs, model)
